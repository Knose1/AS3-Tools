package com.github._knose1.timer {
	...
	public class FrameCounterEvent extends Event {
		...
		/**
		 * Constante qui définie le type d'un object FrameCounterEvent timer
		...
		/**
		 * Constante qui définie le type d'un object FrameCounterEvent timerComplete
		...
		/**
		 * Constante qui définie le type d'un object FrameCounterEvent tick
